...
class TestProcessBookDetailsSuccessScenarios:
    ...
    def test_process_complete_detail_page(self, mock_get):
        ...
        mock_breadcrumb.find_all.return_value = [None, None, mock_category_li]  # Home, Books, Category
        ...
        assert result["detail_url"] == "https://books.toscrape.com/catalogue/complete-book_1/index.html"
    ...
    def test_process_partial_detail_page_missing_description(self, mock_get):
        ...
        mock_response.find.side_effect = [None, mock_breadcrumb]  # No description, has breadcrumb
    ...
    def test_process_partial_detail_page_missing_category(self, mock_get):
        ...
        mock_response.find.side_effect = [mock_description, None]  # Has description, no breadcrumb
        ...
        assert result["description"] == "This book has no category information because the breadcrumb navigation is missing."
    ...
    def test_process_book_with_unicode_characters(self, mock_get):
        ...
        mock_description = MagicMock()
        mock_description.text.strip.return_value = "José's adventure in São Paulo with émojis 📚🚀 and special symbols ñáéíóú"
    ...
    def test_process_book_with_complex_breadcrumb(self, mock_get):
        ...
        mock_breadcrumb = MagicMock()
        breadcrumb_levels = ["Home", "Books", "Fiction", "Mystery", "Crime", "Detective"]
        mock_li_elements = []
    ...
    def test_process_book_with_whitespace_in_data(self, mock_get):
        ...
        mock_description = MagicMock()
        mock_description.text.strip.return_value = "Description with proper whitespace handling"
...
class TestProcessBookDetailsErrorScenarios:
    ...
    def test_description_text_strip_raises_exception(self, mock_get):
        ...
        mock_response.find.side_effect = [mock_description, None]  # Description error, no breadcrumb
        mock_get.return_value = mock_response
