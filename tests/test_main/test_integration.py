...
class TestDataFlowIntegration:
    ...
    def test_book_listing_to_detail_processing_pipeline(
        self, mock_book_listing_page, mock_book_detail_page
    ):
        ...
        with patch("main.Fetcher.get") as mock_get:
            ...
            books = listing_response.find_all(
