...
class TestGetTotalPagesPaginationScenarios:
    ...
    def test_get_total_pages_whitespace_handling(self):
        ...
        test_cases = [
            ...
            (" \n\t Page 1 of 50 \t\n ", 50), # Mixed whitespace (stripped to valid format)
        ]
...
class TestGetTotalPagesErrorHandling:
    ...
    def test_get_total_pages_regex_matching_edge_cases(self):
        ...
        edge_cases = [
            ...
            ("Page 01 of 050", 50),     # Leading zeros (regex matches \d+ which includes leading zeros)
            ("Page 1 of 50.", 50),      # Period after number (regex still matches the digits)
            ("Page 1 of 50,", 50),      # Comma after number (regex still matches the digits)
        ]
    ...
    def test_get_total_pages_unicode_characters_in_pagination(self):
        ...
        unicode_cases = [
            ...
            ("Page 1 of 50 páginas", 50), # Mixed languages (regex still matches the core pattern)
            ("Page 1 of 50 📄", 50),     # Emoji (regex still matches the core pattern)
            ("Page 1 of 50 — Books", 50), # Em dash (regex still matches the core pattern)
            ("Page 1 of 50 • Total", 50), # Bullet point (regex still matches the core pattern)
        ]
